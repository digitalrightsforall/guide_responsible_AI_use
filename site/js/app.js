...
const i18n = {
  en: {
    ...
    heroSubtitle: "A curated collection of existing SKILL.md packages and verified prompts. We do not invent new tools—we help everyday knowledge workers, researchers, and professionals adopt proven guardrails: guarding inward against data harvesting and blind trust, and delivering outward with third-party verifiability.",
  ...
  zh: {
    ...
    heroSubtitle: "精选开源社区现存成熟的 SKILL.md 技能与实务提示词。我们不制造新工具，而是为普通人、学者和写作者把好关：对内防商业 AI 过度采集与盲信幻觉，对外让第三方能够更好验证自己使用 AI 的成果。",
